...
const PrivacyPolicyEN = () => {
  return (
    <View>
      <Text style={{fontSize: 24, fontWeight: '800'}}>Privacy Policy</Text>
      ...
      <Text style={{fontSize: 24, fontWeight: '800'}}>Definitions{'\n'}</Text>
      <Text style={{fontSize: 16}}>
      ...
      <Text style={{fontSize: 16}}>
        {'\u2B24'}Application refers to FinanceNavigator, the software mobile
        application provided by the user.{'\n'}
      </Text>
      <Text style={{fontSize: 16}}>
        {'\u2B24'}Company (referred to as either "the Company", "We", "Us" or
        "Our" in this Agreement) refers to FinanceNavigator.{'\n'}
      </Text>
      <Text style={{fontSize: 16}}>
      ...
      <Text style={{fontSize: 18, fontWeight: '500'}}>Personal Data{'\n'}</Text>
      <Text style={{fontSize: 16}}>
      ...
      <Text style={{fontSize: 18, fontWeight: '500'}}>Usage Data</Text>
      <Text style={{fontSize: 16}}>
      ...
      <Text style={{fontSize: 16}}>
        ...
        {'\u2B24\b'}Pictures and other information from your Device's camera and
        photo library
        {'\n\n'}
      ...
      <Text style={{fontSize: 16}}>
        {'\u2B24\b'}To provide and maintain our Service, including to monitor
        the usage of our Service. {'\n\n'}
        {'\u2B24\b'}To manage Your Account: to manage Your registration as a
        ...
        registered user.{'\n\n'}
        {'\u2B24\b'}For the performance of a contract: the development,
        compliance and undertaking of the purchase contract for the products,
        items or services You have purchased or of any other contract with Us
        through the Service.{'\n\n'}
        {'\u2B24\b'}To contact You: To contact You by email, telephone calls,
        ...
        {'\u2B24\b'}To provide You with news, special offers and general
        ...
        {'\u2B24\b'}To manage Your requests: To attend and manage Your requests
        to Us.{'\n\n'}
        {'\u2B24\b'}For business transfers: We may use Your information to
        ...
        {'\u2B24\b'}For other purposes: We may use Your information for other
        ...
        situations:
        {'\n\n'}
        {'\u2B24\b'}With Service Providers: We may share Your personal
        information with Service Providers to monitor and analyze the use of our
        Service, to contact You.{'\n\n'}
        {'\u2B24\b'}For business transfers: We may share or transfer Your
        ...
        {'\u2B24\b'}With Affiliates: We may share Your information with Our
        ...
        {'\u2B24\b'}With business partners: We may share Your information with
        Our business partners to offer You certain products, services or
        promotions.{'\n\n'}
        {'\u2B24\b'}With other users: when You share personal information or
        ...
        profile.
        {'\n\n'}
        {'\u2B24\b'}With Your consent: We may disclose Your personal information
      ...
      <Text style={{fontSize: 16}}>
        ...
        {'\n\n'}
        {'\u2B24\b'}Prevent or investigate possible wrongdoing in connection
        with the Service
        {'\n\n'}
        {'\u2B24\b'}Protect the personal safety of Users of the Service or the
        public
        {'\n\n'}
        {'\u2B24\b'}Protect against legal liability
        {'\n\n'}
      </Text>
      <Text style={{fontSize: 20, fontWeight: '600'}}>
      ...
      <Text style={{fontSize: 20, fontWeight: '600'}}>Contact Me{'\n'}</Text>
      <Text style={{fontSize: 16}}>
        If you have any questions about this Privacy Policy, You can contact me:
        {'\n'}
        {'\u2B24\b'}By email: adixon2k14@gmail.com
      </Text>
    </View>
  );
};
